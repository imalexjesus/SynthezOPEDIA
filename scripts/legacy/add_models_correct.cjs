...
// Find the end of the synths array - look for "];" that appears after the last model
// We need to find it before the export statements
...
if (closingBracketLine === -1) {
  console.error('Could not find closing bracket of synths array');
  process.exit(1);
}
...
const newModels = [
  {id: 'yamaha-vss-vss-30', brand: 'Yamaha', series: 'VSS (Sampling Synthesizer)', modelName: 'VSS-30', year: 1988, formFactor: 'mini', keysCount: 32, synthEngine: 'семплер', description: 'Портативный семплер с 8-битным сэмплированием.', isGem: true, images: ['https://example.com/vss-30-1.jpg']},
  ...
  {id: 'yamaha-su-su-10', brand: 'Yamaha', series: 'SU (Sampling Unit)', modelName: 'SU-10', year: 1990, formFactor: 'mini', keysCount: 25, synthEngine: 'семплер', description: 'Компактный сэмплер с возможностью записи.', isGem: false, images: ['https://example.com/su-10-1.jpg']},
  ...
  {id: 'yamaha-shs-shs-10', brand: 'Yamaha', series: 'SHS (Headset Synthesizer)', modelName: 'SHS-10', year: 1987, formFactor: 'mini', keysCount: 25, synthEngine: 'FM (2-операторный)', description: 'Носимый синтезатор с наушниками.', isGem: false, images: ['https://example.com/shs-10-1.jpg']},
